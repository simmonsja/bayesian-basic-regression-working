...
We can specify a linear regression model using a PPL $y = \beta_0 + \beta_1 x$ and then fit values for $\beta_0$ and $\beta_1$. Given some propsed values for the parameters, `NumPyro` will tell us the log-likelihood for these values given the model and the data. Sweet.
