...
2. We define the model as a linear regression with an intercept (`beta_0`) and a slope (`beta_1`). `mu` ($\mu$) stores the out of this model as we defined above i.e., $\mu = \mathbf{X}\mathbf{\beta}$.
