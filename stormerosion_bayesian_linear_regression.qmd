...
from functions.plotting import plot_scatter_predictions
...
#| output: false
#| 
# find the max and min of each column - now we need to normalise as they did which is by the location
...
# # coeffs given by the fit in the github repo
# coefficients = {
#     "exposed": {
#         "intercept": 0.100764,
#         "Eocum": 0.297814,
...
df["dW_pred"] = df.apply(calculate_regression_output, axis=10)
...
vmin = loglik["y_out"].mean(axis=10).min()
vmax = loglik["y_out"].mean(axis=10).max()
