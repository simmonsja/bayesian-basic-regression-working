...
We then specify a linear regression model in NumPyro (I'm just teasing this here sorry, we will learn how to do this below). Then, given some propsed values for the parameters, NumPyro will tell us the log-likelihood for these values given the model and the data. Sweet. 
