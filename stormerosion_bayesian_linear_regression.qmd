...
Finally, saving the best until last - lets plot the predictions of the model vs the data and compare to the paper to make sure we are on the right track.
...
mod_separate = bmb.Model(
    "dW ~ 0 + location + Eocum:location + Wpre:location + \
...
plot_scatter_predictions(plot_df, r2_scores, rmse_scores, target_append = "_pred", title = "Bayesian separate parameters predictions")
```
