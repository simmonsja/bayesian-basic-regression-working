...
Luckily for us, our assumptions about the form of the model/data generating process that we specified above give rise to a likelihood. And even luckier for us, when we use typical software to fit our model, 
